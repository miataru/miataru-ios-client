...
extension MiataruAutomationEventKind: AppEnum {
    ...
    static var caseDisplayRepresentations: [MiataruAutomationEventKind: DisplayRepresentation] = [
        ...
        .trackingPaused: DisplayRepresentation(title: LocalizedStringResource("automation_event_kind_tracking_paused", defaultValue: "Tracking Paused", table: "AutomationEvents", comment: "Display name for tracking paused automation event")),
        .trackingResumed: DisplayRepresentation(title: LocalizedStringResource("automation_event_kind_tracking_resumed", defaultValue: "Tracking Resumed", table: "AutomationEvents", comment: "Display name for tracking resumed automation event")),
