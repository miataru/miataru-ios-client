...
struct iPad_GroupMapView: View {
                                ...
                                Rectangle()
                                    ...
                                    .contextMenu {
                                        Button {
                                            ...
                                            Label(NSLocalizedString("edit_device", tableName: "Devices", comment: "Edit this device"), systemImage: "pencil").labelStyle(.titleAndIcon)
                                        }
                                        if deviceID != thisDeviceIDManager.shared.deviceID {
                                            Button {
                                                ...
                                                Label(NSLocalizedString("navigation", tableName: "MapNavigationHistory", comment: "Navigate to this device"), systemImage: "location").labelStyle(.titleAndIcon)
                                            }
                                        }
                                        Button {
                                            ...
                                            Label(NSLocalizedString("show_history", tableName: "MapNavigationHistory", comment: "Show device history"), systemImage: "clock.arrow.circlepath").labelStyle(.titleAndIcon)
                                        }
                                    }
                            }
                            .offset(y: 35)
    ...
    private func updateButton() -> some View {
        NavigationLink(destination: iPad_GroupDetailView(group: group)) {
            Text("group_detailview_edit", tableName: "Groups")
        }
    }*/
