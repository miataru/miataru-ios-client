...
xcodebuild clean build archive -scheme "SwiftImageReadWrite" -destination 'generic/platform=tvOS' -quiet
xcodebuild test -scheme "SwiftImageReadWrite" -destination 'platform=tvOS Simulator,name=Apple TV' -quiet
